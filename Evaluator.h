...
namespace Evaluator {
namespace {
std::array<int, 64> C(std::array<int, 64> a, int b) {
...
template <int s = 64>
std::array<int, s> I(std::array<int, s> array) {
...
namespace Material {
namespace Pawn { int MG = 82; int EG = 94; } // namespace Pawn
namespace Knight {int MG = 337; int EG = 281; } // namespace Knight
namespace Bishop { int MG = 365; int EG = 297; } // namespace Bishop
namespace Rook { int MG = 447; int EG = 512; } // namespace Rook
namespace Queen {int MG = 1025; int EG = 936; } // namespace Queen

std::array<int, 6> MG = {Pawn::MG, Knight::MG, Bishop::MG, Rook::MG, Queen::MG, 0};
std::array<int, 6> EG = {Pawn::EG, Knight::EG, Bishop::EG, Rook::EG, Queen::EG, 0};
} // namespace Material
...
inline std::array<std::array<std::array<int, 64>, 6>, 2> MG{MG_BLACK, MG_WHITE};
inline std::array<std::array<std::array<int, 64>, 6>, 2> EG{EG_BLACK, EG_WHITE};
} // namespace Evaluator
